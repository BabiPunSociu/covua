...
const resourcesRegister = {
  ...
  step3: {
    ...
    textWarningFirstname: {
      "en-US": "First name maximum 255 characters.",
      "vi-VN": "Họ đệm tối đa 255 ký tự.",
    },
    textLastname: {
      "en-US": "Last name",
      "vi-VN": "Tên",
    ...
    textWarningLastname: {
      "en-US": "Last name from 1 to 255 characters.",
      "vi-VN": "Tên từ 1 đến 255 ký tự.",
    },
    textUsername: {
      "en-US": "Username",
      "vi-VN": "Tên tài khoản",
    ...
    textWarningPasswordNotMatch: {
      "en-US": "Password and confirm password do not match.",
      "vi-VN": "Mật khẩu và nhập lại mật khẩu không khớp.",
    },
    textEmail: {
      "en-US": "Email",
      "vi-VN": "Email",
